...
<?php require($_SERVER['DOCUMENT_ROOT'] . '/movie_project/movie_database_tables/genre/genre_processor.php'); ?>
<!doctype html>
<html lang="en">
<head>
...
<form id="director_form">
    <div class="container-fluid" id="genre_page">
        <!-- SEARCH BAR ROW ################################################################## -->
        <div class="row between-xs" id="index_header">

            <div class="col-sm-11 m-4 d-grid gap-4 rcorner-sm border-success lt-purple">
                <?php require($_SERVER['DOCUMENT_ROOT'] . '/movie_project/movie_database_tables/genre/genre_header.php'); ?>
            </div>

            <div class="col-sm-3 d-grid gap-3 p-4 height">
                <?php require($_SERVER['DOCUMENT_ROOT'] . '/movie_project/movie_database_tables/genre/genre_buttons.php'); ?>
            </div>
