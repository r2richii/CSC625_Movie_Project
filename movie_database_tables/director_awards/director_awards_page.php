...
<?php require($_SERVER['DOCUMENT_ROOT'] . '/movie_project/movie_database_tables/director_awards/director_awards_processor.php'); ?>
<!doctype html>
<html lang="en">
<head>
...
<form id="director_form">
    <div class="container-fluid" id="director_awards_page">
        <!-- SEARCH BAR ROW ################################################################## -->
        <div class="row between-xs" id="index_header">

            <div class="col-sm-11 m-4 d-grid gap-4 rcorner-sm border-success lt-purple">
                <?php require($_SERVER['DOCUMENT_ROOT'] . '/movie_project/movie_database_tables/director_awards/director_awards_header.php'); ?>
            </div>

            <div class="col-sm-3 d-grid gap-3 p-4 height">
                <?php require($_SERVER['DOCUMENT_ROOT'] . '/movie_project/movie_database_tables/director_awards/director_awards_buttons.php'); ?>
            </div>
